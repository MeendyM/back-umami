<div>
    <x-modal-header wire:model="modalDelete" title='¿Eliminar proveedor?'>
        <div class="w-full flex items-center text-center">
            <p class="max-w-[400px] mx-auto text-smm text-gray py-3">Esta acción no se puede deshacer, se eliminará la
                relacion del proveedor y los productos, tendra que hacerlo de nuevo manualmente.</p>
        </div>
        <x-slot name="footer" class="space-x-1 space-y-3 flex flex-col">
            <x-primary-button type="button" class="!border-blue" wire:click="deleteSupplier()">
                Eliminar
            </x-primary-button>
