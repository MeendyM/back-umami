                                            ...
                                            <div class="flex justify-between items-start mb-3">
                                                <div class="flex-1">
                                                    <div class="flex items-center gap-2 mb-2">
                                                        <span class="text-sm font-semibold text-gray-700">Recibo #{{ $receipt->id_receip }}</span>
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                                                        ...
                                                        <div>
                                                            <span class="font-medium text-gray-600">ID Transacción:</span>
                                                        ...
                                                        <div>
                                                            ...
                                                            <p>{{ $receipt->created_at->format('d/m/Y H:i') }}</p>
                                                        </div>
                                                    </div>
                                                </div>
