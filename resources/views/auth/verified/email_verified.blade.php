    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-gray-800/80 backdrop-blur-sm rounded-xl shadow-2xl border border-gray-700 p-8 text-center">
            ...
            <p class="text-gray-400 mb-8 leading-relaxed">
                Tu correo ha sido verificado exitosamente. Ya puedes acceder a todas las funcionalidades de la plataforma.
            </p>
            ...
            <a href="{{ env('FRONT_LOGIN_URL', '/') }}" 
               class="inline-block w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white py-4 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-decoration-none text-center">
                Ir al login
            </a>
